...
export OUTPUT_DIR=bioasq_out_list
rm -rf ${OUTPUT_DIR}
mkdir -p $OUTPUT_DIR

export DFILENAME=6b/train/Appended-Snippet/BioASQ-train-list-6b-snippet-2sent.json
export PREDICT_FILE=${BIOASQ_DIR}7b/train/Appended-Snippet/BioASQ-train-list-7b-snippet-2sent.json
