...
def generate_classifier_dataset():
    ...
    processors = {
        ...
        "bioasq": classifier_data_lib.BioASQProcessor,
    }
...
def generate_bioasq_dataset():
    """Generates bioasq training dataset and returns input metadata."""
    assert FLAGS.bioasq_data_file
    return squad_lib.generate_tf_record_from_json_file
