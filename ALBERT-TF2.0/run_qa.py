...
def predict_squad(strategy, input_meta_data):
    ...
    eval_examples = qa_lib.read_bioasq_examples(
    ...
    eval_writer = qa_lib.FeatureWriter(
    ...
    # later on.
    dataset_size = qa_lib.convert_examples_to_features(
...
#list_file = '../BioASQ-6b/train/Appended-Snippet/BioASQ-train-list-6b-snippet-2sent.json'
#test_list = qa_lib.read_bioasq_examples(list_file, is_training=True)
